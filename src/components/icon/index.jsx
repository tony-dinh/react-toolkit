...
const ArrowDownIcon = (props) => {
    return (
        <svg {...props} viewBox="0 0 20 20" preserveAspectRatio="xMidYMid meet">
            <path d="M10 19.25l-5.5-5.25h3.5v-13h4v13h3.5l-5.5 5.25z" />
        </svg>
    )
}
...
const ArrowUpIcon = (props) => {
    return (
        <svg {...props} viewBox="0 0 20 20" preserveAspectRatio="xMidYMid meet">
            <path d="M10 0.75l5.5 5.25h-3.5v13h-4v-13h-3.5l5.5-5.25z" />
        </svg>
    )
}
...
const ChartIcon = (props) => {
    return (
        <svg {...props} viewBox="2 2 20 20" preserveAspectRatio="xMidYMid meet">
            <path d="M0 0h24v24H0z" fill="none" />
...
const EqualizerIcon = (props) => {
    return (
        <svg {...props} viewBox="0 0 32 32" preserveAspectRatio="xMidYMid meet">
...
const FacebookIcon = (props) => {
    return (
        <svg {...props} viewBox="0 0 16 28" preserveAspectRatio="xMidYMid meet">
...
const LinkedInIcon = (props) => {
    return (
        <svg {...props} viewBox="0 0 24 28" preserveAspectRatio="xMidYMid meet">
...
const PlayIcon = (props) => {
    return (
        <svg {...props} viewBox="3 3 18 18" preserveAspectRatio="xMidYMid meet">
...
const TwitterIcon = (props) => {
    return (
        <svg {...props} viewBox="0 0 26 28" preserveAspectRatio="xMidYMid meet">
...
class Icon extends React.PureComponent {
    render() {
        ...
        return (
            <div className={classes} ref={iconRef} style={style}>
                {React.cloneElement(Svg, {className: svgClasses})}
            </div>
        )
    }
}
